...
if __name__ == "__main__":
    ...
    Y0_bar_hat = np.zeros((nDim, N, N_EXP, len(K_array)))
    Y1_bar_hat = np.zeros((nDim, N, N_EXP, len(K_array)))
    Y2_tilde_hat = np.zeros((nDim, N, N_EXP, len(K_array)))
    H2_hat = np.zeros((nDim, nDim, N_EXP, len(K_array)))
    err_b0_hat = np.zeros((n_bar, N_EXP, len(K_array)))
    err_b1_hat = np.zeros((n_bar, N_EXP, len(K_array)))
    err_b2_hat = np.zeros((n_bar, N_EXP, len(K_array)))
    err_b3_hat = np.zeros((n_bar, N_EXP, len(K_array)))
    err_b4_hat = np.zeros((n_bar, N_EXP, len(K_array)))
    err_y0_hat = np.zeros((nDim * N, N_EXP, len(K_array)))
    err_y1_hat = np.zeros((nDim * N, N_EXP, len(K_array)))
    err_y2_hat = np.zeros((nDim * N, N_EXP, len(K_array)))
    rmse_b0_hat = np.zeros(len(K_array))
    rmse_b1_hat = np.zeros(len(K_array))
    rmse_b2_hat = np.zeros(len(K_array))
    rmse_b3_hat = np.zeros(len(K_array))
    rmse_b4_hat = np.zeros(len(K_array))
    rmse_y0_hat = np.zeros(len(K_array))
    rmse_y1_hat = np.zeros(len(K_array))
    rmse_y2_hat = np.zeros(len(K_array))

    Y0_bar_acc = np.zeros((nDim, N, N_EXP, len(K_array)))
    Y1_bar_acc = np.zeros((nDim, N, N_EXP, len(K_array)))
    Y2_tilde_acc = np.zeros((nDim, N, N_EXP, len(K_array)))
    H2_acc = np.zeros((nDim, nDim, N_EXP, len(K_array)))
    err_b0_acc = np.zeros((n_bar, N_EXP, len(K_array)))
    err_b1_acc = np.zeros((n_bar, N_EXP, len(K_array)))
    err_b2_acc = np.zeros((n_bar, N_EXP, len(K_array)))
    err_b3_acc = np.zeros((n_bar, N_EXP, len(K_array)))
    err_y0_acc = np.zeros((nDim * N, N_EXP, len(K_array)))
    err_y1_acc = np.zeros((nDim * N, N_EXP, len(K_array)))
    err_y2_acc = np.zeros((nDim * N, N_EXP, len(K_array)))
    rmse_b0_acc = np.zeros(len(K_array))
    rmse_b1_acc = np.zeros(len(K_array))
    rmse_b2_acc = np.zeros(len(K_array))
    rmse_b3_acc = np.zeros(len(K_array))
    rmse_y0_acc = np.zeros(len(K_array))
    rmse_y1_acc = np.zeros(len(K_array))
    rmse_y2_acc = np.zeros(len(K_array))
